...
const PixelToggle = class {
    ...
    render() {
        return (index.h(index.Host, { tabIndex: (this.disabled) ? -1 : 0, onClick: () => this.onClick(), onKeyPress: (event) => this.onKeyPress(event), onKeyUp: (event) => this.onKeyUp(event), style: this.computedStyle }, index.h("div", { class: "pixel-active-wrapper" }), index.h("div", { class: "pixel-wrapper" }), index.h("div", { class: "slider" }, index.h("div", { class: { 'slider-switch': true, 'active': this.checked } }, index.h("div", { class: "slider-switch-wrapper" })))));
    }
    get root() { return index.getElement(this); }
};
PixelToggle.style = pixelToggleCss;

exports.pixel_toggle = PixelToggle;
