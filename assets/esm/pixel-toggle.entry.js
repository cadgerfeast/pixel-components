...
const PixelToggle = class {
    ...
    render() {
        return (h(Host, { tabIndex: (this.disabled) ? -1 : 0, onClick: () => this.onClick(), onKeyPress: (event) => this.onKeyPress(event), onKeyUp: (event) => this.onKeyUp(event), style: this.computedStyle }, h("div", { class: "pixel-active-wrapper" }), h("div", { class: "pixel-wrapper" }), h("div", { class: "slider" }, h("div", { class: { 'slider-switch': true, 'active': this.checked } }, h("div", { class: "slider-switch-wrapper" })))));
    }
